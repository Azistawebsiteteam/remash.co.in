		...
		<div class="container">	
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto scrollpy">
					...
					<li class="nav-item <?php if(!empty($active_item)){ if($active_item =="awareness_hub"){ echo"active"; }} ?>">
						<a class="nav-link " name='link' href="<?php echo base_url();?>mash-awareness-hub">Mash & Awareness Hub</a>
					</li>					
					<!-- <li
