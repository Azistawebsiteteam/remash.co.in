...
//Email Settings
define('EmailAPI', 'https://services.heterohcl.com/SMTP_EMAIL/azistabhutan');
define('EmailSignature', '<strong>Thanks & Regards</strong><br> Sales Team, <br>Azista Bhutan Healthcare Limited.');
//Analytics
...
define('GoogleAnalytics', 'True'); //True or False
define('GoogleAnalyticsKey', 'GTM-NFZ6JVX4'); //UA-98598831-1
...
define('Copyright', '<a href="https://azistabhutanhealthcare.com" target="_blank">Azista Bhutan Healthcare Limited</a>');