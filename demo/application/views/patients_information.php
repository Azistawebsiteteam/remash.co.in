			...
			<div class="row">
				<div class="col-md-12 healthcare_content_sec">
					<div class="healthcare_content">
					    <h1 class="healthcare_title">Patient Information</h1>	
						<h2 class="healthcare_sub_title">Understanding ReMASH™ for Your Liver Health</h2>					
					...
					<div class="healthcare_details">
						...
						<ul>
							<li>medicines that contain gemfibrozil (for triglycerides)</li>
							<li>cyclosporine (for immune suppression)</li>
							<li>clopidogrel (blood thinner)</li>
							<li>statin medicines (to lower cholesterol)</li>
						</ul>
						<p>Keep a list of all your medicines and share it with your doctor or pharmacist when you get a new prescription.</p>
					</div>
					<div class="healthcare_details">
					...
					<div class="healthcare_details destop_block">
						...
						<p>Call your doctor for medical advice about side effects. <br>You may report side effects to the FDA at 1-800-FDA-1088 or <a class="ancor_style" target="_blank" href="https://www.fda.gov/safety/medwatch-fda-safety-information-and-adverse-event-reporting-program">www.fda.gov/medwatch.</a></p>
						</div>
					</div>
					...
					<div class="healthcare_details">
						...
						<ul>
							...
							<li>You can ask your healthcare provider or pharmacist for more information</li>
						</ul>
					</div>
					<div class="healthcare_details">
					...
					<!--<div class="healthcare_details">-->
					<!--	<h5 class="sub_title">Manufactured for and distributed by</h5>-->
					<!--	<ul>-->
					...
					<!--</div>-->
					<div >
						<p class="mb-0">If you've been diagnosed with MASH, ReMASH™ may be the first step toward taking back control of your liver health.</p>
					</div>					
				</div>				
			</div>
		</div>
