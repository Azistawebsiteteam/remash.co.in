			...
			<div class="row">
				<div class="col-md-12 healthcare_content_sec">
					<div class="healthcare_content">
						...
						<h2 class="healthcare_sub_title">ReMASH™ (Resmetirom) Clinical Overview</h2>					
						<p class="healthcare_text"><i>Tablets for oral use</i></p>						
					</div>
					<div class="healthcare_details">
						<h5 class="sub_title">Indications</h5>
					...
					<div class="healthcare_details">
						...
						<ul>
							<li>Recommended starting dose: 80mg or 100mg once daily, based on patient’s weight and tolerability</li>
					...
					<div class="healthcare_details destop_block">
						...
						<div class="side_effects_section ">
							...
							<div class="side_effect_img">
								<img loading="eager"
							src="<?php echo base_url();?>/assets/img/abdominal_pain.webp?Version=<?php echo Version; ?>"
							alt="abdominal_pain" class="" />
							<p>Abdominal pain</p>
							</div>
							<div class="side_effect_img">
								<img loading="eager"
						...
						<div class="side_effects_section ">
							<div class="side_effect_img ">
								<img loading="eager"
							src="<?php echo base_url();?>/assets/img/hepatotoxicity.webp?Version=<?php echo Version; ?>"
							alt="Hepatotoxicity" class="" />
							<p>Hepatotoxicity</p>
							</div>
							<div class="side_effect_img ">
								<img loading="eager"
							src="<?php echo base_url();?>/assets/img/gallbladder_disease.webp?Version=<?php echo Version; ?>"
							alt="gallbladder_disease" class="" />
							<p>Gallbladder disease</p>
							</div>
							<div class="side_effect_img ">
								<img loading="eager"
							src="<?php echo base_url();?>/assets/img/pancreatitis_secondary_to_biliary_complications.webp?Version=<?php echo Version; ?>"
							alt="pancreatitis_secondary_to_biliary_complications" class="" />
						...
						<div class="side_effects_section ">
							...
							<div class="mobile_flex">
								<div class="side_effect_img">
									<img loading="eager"
								src="<?php echo base_url();?>/assets/img/dizziness.webp?Version=<?php echo Version; ?>"
								alt="dizziness2" class="" />
								<p>Dizziness</p>
								</div>
								<div class="side_effect_img">
									<img loading="eager"
								src="<?php echo base_url();?>/assets/img/abdominal_pain.webp?Version=<?php echo Version; ?>"
								alt="abdominal_pain2" class="" />
								<p>Abdominal pain</p>
								</div>
								<div class="side_effect_img">
									<img loading="eager"
						...
						<div class="side_effects_section ">
							<div class="mobile_flex">
								<div class="side_effect_img ">
									<img loading="eager"
								src="<?php echo base_url();?>/assets/img/hepatotoxicity.webp?Version=<?php echo Version; ?>"
								alt="hepatotoxicity2" class="" />
								<p>Hepatotoxicity</p>
								</div>
								<div class="side_effect_img ">
									<img loading="eager"
								src="<?php echo base_url();?>/assets/img/gallbladder_disease.webp?Version=<?php echo Version; ?>"
								alt="gallbladder_disease2" class="" />
								<p>Gallbladder disease</p>
								</div>
								<div class="side_effect_img ">
									<img loading="eager"
								src="<?php echo base_url();?>/assets/img/pancreatitis_secondary_to_biliary_complications.webp?Version=<?php echo Version; ?>"
								alt="pancreatitis_secondary_to_biliary_complications2" class="" />
								<p style="width: 100px">Pancreatitis secondary to biliary complications.</p>
								</div>
							</div>
						</div>
					...
					<div class="healthcare_details">
						...
						<ul>
							<li>Tablets: 60mg, 80mg, and 100mg</li>
							<li>Storage: 20°C to 25°C (68°F to 77°F)</li>
							<li>Blister and bottle packs with moisture control</li>
						</ul>
					</div>
					<div class="">
						<p class="mb-0"><strong>Please see the accompanying full <a class="sub_color" href="<?php echo base_url();?>prescribing-information">Prescribing Information</a>, including <a class="sub_color" href="<?php echo base_url();?>patient-information">Patient Information</a>, for ReMASH</strong></p>
					</div>
				</div>				
			</div>
		</div>
