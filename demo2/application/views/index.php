				...
				<div class="carousel-item active">
					<div class="">
						...
						<div class="banner_title_section">
							...
							<p class="banner_text">The first and only FDA-approved oral therapy for adults with non-cirrhotic MASH (F2-F3).</p>
			...
			<div class="row">
				<div class="col-md-6 about_content_sec">
					<div class="about_content">
						...
						<ul>
							<li>NASH resolution in up to 29% of patients vs 9% on placebo</li>
							...
							<li>Well-tolerated with mostly mild gastrointestinal side effects</li>
						</ul>			
					</div>
				</div>
				<div class="col-md-6">
